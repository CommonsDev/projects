...
angular.module('unisson_projects', ['project_sheet', 'ui.router', 'ngAnimate', 'restangular', 'xeditable', 'chieffancypants.loadingBar'])
...
.config(['$locationProvider', '$stateProvider', '$urlRouterProvider', ($locationProvider, $stateProvider, $urlRouterProvider) ->
        ...
        .state('project-list',
                ...
                templateUrl: 'partials/project_sheet/project_list.html'
        )

        .state('project-detail',
                url: '/p/:id',
                templateUrl: 'partials/project_sheet/page/project_detail.html'
...
.run(['$rootScope', '$state', '$stateParams', 'editableOptions', ($rootScope, $state, $stateParams, editableOptions) ->
